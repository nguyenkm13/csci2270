...
void Graph::dijkstraTraverse(string start)
{
    ...
    while(solved.size() < vertices.size()) {
        int minDist = 2147483647; // max integer value 
        vertex *solvedV = NULL; // temporarily stores solved vertices
        vertex *parent = NULL; // temporaritly stores parent path vertices
